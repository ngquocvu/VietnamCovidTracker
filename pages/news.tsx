      ...
      <main className="flex w-full px-2 pt-4 pb-6 items-start justify-center md:max-w-7xl  ">
        ...
        <div className="hidden lg:flex flex-col md:w-3/12 bg-white transition cursor-pointer hover:shadow-sm transition-shadow duration-100 ease-in-out rounded-xl p-4 mx-4 shadow-md">
          ...
          <div className="py-4 flex space-y-2 items-center flex-col">
            <div className="text-gray-500 text-md">Hồ Chí Minh</div>
            <img
            ...
            />
            <div className="text-gray-500 font-semibold text-4xl">32°C</div>
            <div className="text-gray-600 font-normal">Có mây</div>
          </div>
        </div>
      </main>
    </motion.div>
